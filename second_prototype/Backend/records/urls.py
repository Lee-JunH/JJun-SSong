...
from .views import (
    CalendarMonthView, DayDetailView,
    AddMealView, DeleteMealView,
    AddExerciseView, UpsertWeightView,
    UpsertConditionView, ToggleSupplementView
)
...
urlpatterns = [
    ...
    path("days/<str:day_str>/supplements/", ToggleSupplementView.as_view()),
]
